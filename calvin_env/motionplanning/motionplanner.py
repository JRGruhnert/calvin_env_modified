...
from scene.play_table_scene import PlayTableScene
OPEN = 1
CLOSED = -1


class MotionPlanningSolver:
    def __init__(
        self,
        env: PlayTableSimEnv,
        debug: bool = False,
        ...
        self.env = env
        self.base_env: PlayTableSimEnv = env.unwrapped
...
def build_panda_gripper_grasp_pose_visual(scene: PlayTableScene):
